...
def home():
    ...
    try:
        ...
        msg = 'Token anda telah kadaluarsa'
        return redirect(url_for('login', msg=msg))
    except jwt.exceptions.DecodeError:
        msg = 'Ada masalah dengan registrasi anda'
        return redirect(url_for('login', msg=msg))
...
def sign_up():
    ...
    # Perbaikan: Menggunakan nama koleksi yang benar
    db.user.insert_one(doc)
    return jsonify({'result': 'success'})

# root cek akun duplikat
...
# halaman detail postingan(menampilkan postingan)
